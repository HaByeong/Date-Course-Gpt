...
public class DateCourseRequest implements Serializable{
    ...
    public String toPromptString(){
        return "\"---\" 아래의 토픽에 대해 예를 들어줘."
               ...
               + "- Format : 리스트"
               + "\"---\""
                +"1. 사용자가 입력한 금액 " + userChat +"을 기반으로 데이트 코스를 추천합니다. 이때, 추천하는 장소는 사전에 정해진 리스트에서 랜덤으로 선정되며, 사용자의 예산을 초과하지 않도록 조심스럽게 계획됩니다."
                ...
                +"4. 만약 사용자가 남은 금액으로 추가적인 장소 추천을 원하면, 남은 금액을 초과하지 않는 범위에서 리스트 내 임의의 장소를 추천합니다."
                +"위 조건들을 반드시 지켜서 출력해줘";
    }
}
